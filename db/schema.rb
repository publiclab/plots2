...
ActiveRecord::Schema.define(:version => 20130327222827) do
  ...
  create_table "accesslog", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "actions", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "actions_aid", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
  end

  create_table "activity", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "activity_access", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "aid",                  :null => false
    t.string  "realm",                :null => false
    t.integer "value", :default => 0, :null => false
  end

  create_table "activity_comments", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "activity_comments_stats", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "activity_messages", :primary_key => "amid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.text "message", :limit => 2147483647, :null => false
  end

  create_table "activity_targets", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "aid",                                   :null => false
    t.integer "uid",                    :default => 0, :null => false
  ...
  add_index "activity_targets", ["amid"], :name => "amid"

  create_table "advanced_help_index", :primary_key => "sid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "aggregator_category", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "title",                             :default => "", :null => false
    t.text    "description", :limit => 2147483647,                 :null => false
    t.integer "block",       :limit => 1,          :default => 0,  :null => false
  end

  add_index "aggregator_category", ["title"], :name => "title"

  create_table "aggregator_category_feed", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "aggregator_category_item", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "aggregator_feed", :primary_key => "fid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "title",                             :default => "", :null => false
  ...
  add_index "aggregator_feed", ["title"], :name => "title"
  add_index "aggregator_feed", ["url"], :name => "url"

  create_table "aggregator_item", :primary_key => "iid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "fid",                               :default => 0,  :null => false
    t.string  "title",                             :default => "", :null => false
    t.string  "link",                              :default => "", :null => false
  ...
  create_table "antispam_counter", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "antispam_moderator", :primary_key => "uid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "email_for", :limit => 20, :default => "", :null => false
  end

  add_index "antispam_moderator", ["email_for"], :name => "email_for"

  create_table "antispam_spam_marks", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "authmap", :primary_key => "aid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                     :default => 0,  :null => false
    t.string  "authname", :limit => 128, :default => "", :null => false
    t.string  "module",   :limit => 128, :default => "", :null => false
  end

  add_index "authmap", ["authname"], :name => "authname"

  create_table "autoload_registry", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "autoload_registry_file", :primary_key => "filename", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "hash", :limit => 64, :null => false
  end

  create_table "backup_migrate_destinations", :primary_key => "destination_id", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "backup_migrate_profiles", :primary_key => "profile_id", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",                                          :null => false
  ...
  create_table "backup_migrate_schedules", :primary_key => "schedule_id", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",                                           :null => false
  ...
  create_table "batch", :primary_key => "bid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "blocks", :primary_key => "bid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "blocks", ["theme", "module", "delta"], :name => "tmd"
  add_index "blocks", ["theme", "status", "region", "weight", "module"], :name => "list"

  create_table "blocks_roles", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "book", :primary_key => "mlid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "nid", :default => 0, :null => false
    t.integer "bid", :default => 0, :null => false
  end

  add_index "book", ["bid"], :name => "bid"
  add_index "book", ["nid"], :name => "nid"

  create_table "boost_cache", :primary_key => "hash", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "boost_cache_relationships", :primary_key => "hash", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "base_dir",            :limit => 128, :default => "",  :null => false
    t.string  "page_callback",                      :default => "",  :null => false
  ...
  create_table "boost_cache_settings", :primary_key => "csid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "base_dir",      :limit => 128, :default => "",  :null => false
    t.string  "page_callback",                :default => "",  :null => false
    t.string  "page_type",                    :default => "0", :null => false
    t.string  "page_id",       :limit => 64,  :default => "",  :null => false
  ...
  create_table "boost_crawler", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "hash", :limit => 32, :default => "", :null => false
    t.text   "url",                                :null => false
  end

  add_index "boost_crawler", ["hash"], :name => "hash"

  create_table "boxes", :primary_key => "bid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.text    "body",   :limit => 2147483647
    t.string  "info",   :limit => 128,        :default => "", :null => false
    t.integer "format", :limit => 2,          :default => 0,  :null => false
  end

  add_index "boxes", ["info"], :name => "info"

  create_table "cache", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "cache_block", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_content", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_filter", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_form", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_gravatar", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_menu", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_mollom", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_page", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_rules", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_update", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_views", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "cache_views_data", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary  "data",       :limit => 2147483647
    t.integer "expire",                           :default => 0, :null => false
    t.integer "created",                          :default => 0, :null => false
    t.text    "headers"
  ...
  create_table "captcha_points", :primary_key => "form_id", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "module",       :limit => 64
    t.string "captcha_type", :limit => 64
  end

  create_table "captcha_sessions", :primary_key => "csid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "comment_notify", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "comment_notify_user_settings", :primary_key => "uid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "contact", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "contact", ["category"], :name => "category"
  ...
  create_table "content_type_blog", :primary_key => "vid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "nid", :default => 0, :null => false
  end
  ...
  create_table "ctools_access_ruleset", :primary_key => "rsid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "name"
  ...
  create_table "ctools_css_cache", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "filename"
    t.text    "css",      :limit => 2147483647
    t.integer "filter",   :limit => 1
  end

  create_table "ctools_custom_content", :primary_key => "cid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "name"
    t.string "admin_title"
    t.text   "admin_description", :limit => 2147483647
    t.string "category"
  ...
  create_table "ctools_object_cache", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "custom_breadcrumb", :primary_key => "bid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "dashboard_default", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "dashboard_page", :primary_key => "page_id", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                  :null => false
  ...
  add_index "dashboard_page", ["uid", "path"], :name => "uid_path"
  add_index "dashboard_page", ["uid", "weight"], :name => "uid_weight"

  create_table "dashboard_widget", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "date_format_locale", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "format",   :limit => 100, :null => false
    t.string "type",     :limit => 200, :null => false
    t.string "language", :limit => 12,  :null => false
  end

  create_table "date_format_types", :primary_key => "type", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "title",                              :null => false
    t.integer "locked", :limit => 1, :default => 0, :null => false
  end

  create_table "date_formats", :primary_key => "dfid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "format", :limit => 100,                :null => false
    t.string  "type",   :limit => 200,                :null => false
    t.integer "locked", :limit => 1,   :default => 0, :null => false
  end

  add_index "date_formats", ["format", "type"], :name => "formats"

  create_table "devel_queries", :primary_key => "hash", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "devel_times", :primary_key => "tid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "event", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "event_timezones", :primary_key => "timezone", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",       :default => "",                    :null => false
  ...
  create_table "feeds_imagegrabber", :primary_key => "feed_nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "feeds_importer", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.text "config"
  end

  create_table "feeds_node_item", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "feeds_source", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "id",       :limit => 128,        :default => "", :null => false
  ...
  create_table "filter_formats", :primary_key => "format", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",               :default => "", :null => false
    t.string  "roles",              :default => "", :null => false
    t.integer "cache", :limit => 1, :default => 0,  :null => false
  end

  add_index "filter_formats", ["name"], :name => "name"

  create_table "filters", :primary_key => "fid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "filters", ["format", "module", "delta"], :name => "fmd"
  add_index "filters", ["format", "weight", "module", "delta"], :name => "list"

  create_table "flood", :primary_key => "fid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "freelinking", :primary_key => "hash", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "phrase", :limit => 200, :null => false
    t.string "path",   :limit => 200, :null => false
    t.string "args",   :limit => 200, :null => false
  end

  create_table "geo", :primary_key => "gid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",                                      :null => false
    t.string  "title",                                     :null => false
  ...
  create_table "history", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",       :default => 0, :null => false
    t.integer "nid",       :default => 0, :null => false
    t.integer "timestamp", :default => 0, :null => false
  end
  ...
  create_table "imagecache_action", :primary_key => "actionid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "imagecache_preset", :primary_key => "presetid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "invite", :primary_key => "iid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "invite", ["reg_code"], :name => "reg_code"
  add_index "invite", ["uid"], :name => "uid"

  create_table "invite_notifications", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",     :default => 0, :null => false
    t.integer "invitee", :default => 0, :null => false
  end

  add_index "invite_notifications", ["uid", "invitee"], :name => "uid_invitee"

  create_table "job_schedule", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "languages", :primary_key => "language", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "locales_source", :primary_key => "lid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "mailhandler", :primary_key => "mid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "menu_custom", :primary_key => "menu_name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "title",       :default => "", :null => false
    t.text   "description"
  end

  create_table "menu_links", :primary_key => "mlid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "menu_router", :primary_key => "path", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "messaging_store", :primary_key => "mqid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                               :default => 0,  :null => false
  ...
  create_table "mollom", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "mollom_form", :primary_key => "form_id", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "node_comment_statistics", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "notifications_event", :primary_key => "eid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "module"
    t.string  "type"
    t.string  "action"
  ...
  create_table "notifications_fields", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "notifications_queue", :primary_key => "sqid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "notifications_sent", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                         :default => 0, :null => false
  ...
  create_table "notify", :primary_key => "uid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "status",   :limit => 1, :default => 0, :null => false
  ...
  create_table "openid_association", :primary_key => "assoc_handle", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "openid_nonce", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "idp_endpoint_uri"
    t.string  "nonce"
  ...
  create_table "openid_provider_association", :primary_key => "assoc_handle", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "openid_provider_relying_party", :primary_key => "rpid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                          :null => false
    t.string  "realm",        :default => "", :null => false
  ...
  create_table "openlayers_layers", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "title",       :default => "", :null => false
    t.text   "description",                 :null => false
    t.text   "data"
  end
  ...
  create_table "openlayers_map_presets", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "title",       :null => false
    t.text   "description", :null => false
    t.text   "data",        :null => false
  end

  create_table "openlayers_styles", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "title",       :default => "", :null => false
    t.text   "description",                 :null => false
    t.text   "data"
  end
  ...
  create_table "page_manager_handlers", :primary_key => "did", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name"
  ...
  add_index "page_manager_handlers", ["name"], :name => "name"
  add_index "page_manager_handlers", ["task", "subtask", "weight"], :name => "fulltask"

  create_table "page_manager_pages", :primary_key => "pid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "name"
  ...
  add_index "page_manager_pages", ["name"], :name => "name"
  add_index "page_manager_pages", ["task"], :name => "task"

  create_table "page_manager_weights", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "weight"
  end

  add_index "page_manager_weights", ["name", "weight"], :name => "weights"

  create_table "permission", :primary_key => "pid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "print_node_conf", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "print_page_counter", :primary_key => "path", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "totalcount", :limit => 8, :default => 0, :null => false
    t.integer "timestamp",               :default => 0, :null => false
  end

  create_table "print_pdf_node_conf", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "link",     :limit => 1, :default => 1, :null => false
    t.integer "comments", :limit => 1, :default => 1, :null => false
    t.integer "url_list", :limit => 1, :default => 1, :null => false
  end

  create_table "print_pdf_page_counter", :primary_key => "path", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "totalcount", :limit => 8, :default => 0, :null => false
    t.integer "timestamp",               :default => 0, :null => false
  end

  create_table "private", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "protected_nodes", :primary_key => "nid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "passwd", :limit => 40, :default => "", :null => false
  end

  add_index "protected_nodes", ["passwd"], :name => "protected_passwd"

  create_table "role", :primary_key => "rid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "name", :limit => 64, :default => "", :null => false
  end

  add_index "role", ["name"], :name => "name"
  ...
  create_table "rules_rules", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary "data", :limit => 2147483647
  end

  create_table "rules_scheduler", :primary_key => "tid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "rules_sets", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.binary "data", :limit => 2147483647
  end
  ...
  create_table "search_autocomplete_suggestions", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "sid",                             :default => 0,  :null => false
  ...
  create_table "search_dataset", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "sid",                           :default => 0, :null => false
  ...
  add_index "search_dataset", ["sid", "type"], :name => "sid_type"

  create_table "search_index", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "search_index", ["word", "sid", "type"], :name => "word_sid_type"
  add_index "search_index", ["word"], :name => "word"

  create_table "search_node_links", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "sid",                           :default => 0,  :null => false
  ...
  create_table "search_total", :primary_key => "word", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.float "count"
  end

  create_table "semaphore", :primary_key => "name", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "sessions", :primary_key => "sid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                                             :null => false
    t.string  "hostname",  :limit => 128,        :default => "", :null => false
    t.integer "timestamp",                       :default => 0,  :null => false
  ...
  create_table "simpleviews", :primary_key => "svid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "spamicide", :primary_key => "form_id", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "form_field", :limit => 64, :default => "feed_me", :null => false
    t.integer "enabled",    :limit => 1,  :default => 0,         :null => false
    t.integer "removable",  :limit => 1,  :default => 1,         :null => false
  end

  create_table "stylizer", :primary_key => "sid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string "name"
    t.string "admin_title"
    t.text   "admin_description", :limit => 2147483647
    t.text   "settings",          :limit => 2147483647
  ...
  add_index "stylizer", ["name"], :name => "name"

  create_table "system", :primary_key => "filename", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",                        :default => "", :null => false
    t.string  "type",                        :default => "", :null => false
  ...
  create_table "tableofcontents_node_toc", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "term_hierarchy", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "tid",    :default => 0, :null => false
  ...
  create_table "term_relation", :primary_key => "trid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "tid1", :default => 0, :null => false
    t.integer "tid2", :default => 0, :null => false
  end

  add_index "term_relation", ["tid1", "tid2"], :name => "tid1_tid2"
  add_index "term_relation", ["tid2"], :name => "tid2"

  create_table "term_synonym", :primary_key => "tsid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "tid",  :default => 0,  :null => false
    t.string  "name", :default => "", :null => false
  end
  ...
  create_table "to_do", :primary_key => "vid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "nid",                           :default => 0, :null => false
  ...
  create_table "to_do_assigned_users", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "nid", :default => 0, :null => false
    t.integer "vid", :default => 0, :null => false
    t.integer "uid", :default => 1, :null => false
  end

  create_table "to_do_block_user_preferences", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                                     :default => 0, :null => false
    t.integer "sidebar_items",                           :default => 5
    t.integer "low_priority_items_display", :limit => 1, :default => 1
  end

  create_table "token_custom", :primary_key => "tkid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "trigger_assignments", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "users_roles", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid", :default => 0, :null => false
    t.integer "rid", :default => 0, :null => false
  end
  ...
  create_table "views_object_cache", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  create_table "views_view", :primary_key => "vid", :options=>'ENGINE=MyISAM', :force => true do |t|
  ...
  add_index "views_view", ["name"], :name => "name"

  create_table "vocabulary", :primary_key => "vid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.string  "name",                              :default => "", :null => false
    t.text    "description", :limit => 2147483647
  ...
  create_table "vocabulary_node_types", :id => false, :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "vid",                :default => 0,  :null => false
    t.string  "type", :limit => 32, :default => "", :null => false
  end
  ...
  create_table "watchdog", :primary_key => "wid", :options=>'ENGINE=MyISAM', :force => true do |t|
    t.integer "uid",                             :default => 0,  :null => false
    t.string  "type",      :limit => 16,         :default => "", :null => false
    t.text    "message",   :limit => 2147483647,                 :null => false
  ...
  create_table "wysiwyg", :primary_key => "format", :options=>'ENGINE=MyISAM', :force => true do |t|
