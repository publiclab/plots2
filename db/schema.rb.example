...
ActiveRecord::Schema.define(:version => 20161230142222) do
  ...
  add_index "answer_selections", ["user_id", "aid"], :name => "index_answer_selections_on_user_id_and_aid"
  ...
  add_index "answers", ["uid", "nid"], :name => "index_answers_on_uid_and_nid"
  ...
  add_index "comments", ["nid"], :name => "index_comments_nid"
  add_index "comments", ["pid"], :name => "index_comments_pid"
  add_index "comments", ["status"], :name => "index_comments_status"
  ...
  add_index "community_tags", ["nid"], :name => "index_community_tags_nid"
  add_index "community_tags", ["tid", "nid"], :name => "tid_nid"
  add_index "community_tags", ["tid"], :name => "index_community_tags_tid"
  add_index "community_tags", ["uid"], :name => "index_community_tags_uid"
  ...
  add_index "content_field_image_gallery", ["nid"], :name => "index_content_field_image_gallery_nid"
  ...
  add_index "content_field_main_image", ["nid"], :name => "index_content_field_main_image_nid"
  ...
  add_index "content_field_map_editor", ["nid"], :name => "index_content_field_map_editor_nid"
  ...
  add_index "content_field_mappers", ["nid"], :name => "index_content_field_mappers_nid"
  ...
  add_index "content_type_map", ["nid"], :name => "index_content_type_map_nid"
  ...
  add_index "files", ["status"], :name => "index_files_status"
  ...
  add_index "node", ["translate"], :name => "index_node_translate"
  add_index "node", ["type"], :name => "node_type"
  add_index "node", ["uid"], :name => "index_node_uid"
  add_index "node", ["vid"], :name => "index_node_vid"
  ...
  add_index "node_revisions", ["nid"], :name => "index_node_revisions_nid"
  add_index "node_revisions", ["uid"], :name => "index_node_revisions_uid"
  ...
  add_index "node_selections", ["user_id", "nid"], :name => "index_node_selections_on_user_id_and_nid", :unique => true
  ...
  add_index "profile_fields", ["category"], :name => "index_profile_fields_category"
  add_index "profile_fields", ["name"], :name => "index_profile_fields_name"
  ...
  add_index "profile_values", ["fid"], :name => "index_profile_values_fid"
  add_index "profile_values", ["uid"], :name => "index_profile_values_on_uid"
  ...
  create_table "rusers", :force => true do |t|
    ...
    t.string   "photo_content_type"
    t.string   "photo_file_size"
    t.boolean  "location_privacy",   :default => true
  end

  add_index "rusers", ["location_privacy"], :name => "index_rusers_on_location_privacy"
  ...
  add_index "term_node", ["nid"], :name => "index_term_node_nid"
  add_index "term_node", ["vid"], :name => "index_term_node_vid"
  ...
  add_index "upload", ["fid"], :name => "index_upload_fid"
  add_index "upload", ["nid"], :name => "index_upload_nid"
  ...
  add_index "user_selections", ["self_id", "other_id"], :name => "index_user_selections_on_self_id_and_other_id", :unique => true
  ...
  add_index "users", ["access"], :name => "index_users_access"
  add_index "users", ["created"], :name => "index_users_created"
  add_index "users", ["mail"], :name => "index_users_mail"
