...
class SubscriptionMailerTest < ActionMailer::TestCase
  test "notify subscribers on creation of a research note" do
    ...
    assert email.body.include?("Public Lab contributor <a href='https://#{Rails.root}/profile/#{node.author.name}'>#{node.author.name}</a> just posted a new research note")
  end
  ...
  test "notify subscribers on creation of a question" do
    ...
    assert email.body.include?("Public Lab contributor <a href='https://#{Rails.root}/profile/#{node.author.name}'>#{node.author.name}</a> just asked a question")
  end
