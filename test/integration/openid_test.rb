...
class LoginFlowTest < ActionDispatch::IntegrationTest
  ...
  test 'openid authentication request does not go to index page' do
    ...
    get '/openid', params: {
      'openid.claimed_id': "https://mapknitter.org/openid/#{users(:jeff).username}",
      'openid.identity': "https://mapknitter.org/openid/#{users(:jeff).username}",
      'openid.mode': 'checkid_setup',
      'openid.ns': 'http://specs.openid.net/auth/2.0',
      'openid.ns.sreg': 'http://openid.net/extensions/sreg/1.1',
      'openid.realm': 'https://mapknitter.org/',
      'openid.return_to': "https://mapknitter.org/session/new?authenticity_token=RcLcGH3lzSTCC24UpPnNm56sllNaMrHg5%2FSrQzNxB%2B4%3D&back_to=&open_id=#{users(:jeff).username}&return_to=",
      'openid.sreg.required': 'nickname,email'
    }
