...
class HomeControllerTest < ActionController::TestCase
  ...
  test 'should get dashboard if logged in' do
    ...
    get :dashboard
    assert_response :success
    assert_select 'a[href=?]', "mailto:moderators@publiclab.org?subject=Reporting+spam+on+Public+Lab&body=Hi,+I+found+this+item+that+looks+like+spam+or+needs+to+be+moderated:+Canon+A1200+IR+conversion+at+PLOTS+Barnraising+at+LUMCON+https://publiclab.org/n/1+by+https://publiclab.org/profile/<%= node.author.username %>+Thanks!"
  end
