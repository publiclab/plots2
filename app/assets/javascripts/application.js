...
// the compiled file.
// 
//If there are other assets (which are not in this file) that are being precompiled by 'javascript_include_tag' command in views, then add them on /config/initializers/assets.rb
//
