...
# try this; http://jystewart.net/2007/10/24/a-ruby-on-rails-openid-server/
  ...
  get 'spam/batch_spam/:ids' => 'admin#batch_spam'
  get 'spam/batch_publish/:ids' => 'admin#batch_publish'
  get 'spam/batch_delete/:ids' => 'admin#batch_delete'
  get 'spam/batch_ban/:ids' => 'admin#batch_ban'
  get 'spam/batch_unban/:ids' => 'admin#batch_unban'
