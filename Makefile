...
redeploy-container:
	...
	docker-compose run --rm web bash -c "bundle exec rails g webpack:install && bundle exec rails g webpack:install:react && bundle exec rails g react:install"
...
deploy-container:
	docker-compose run --rm web yarn install
	docker-compose run --rm web bash -c "sleep 5 && bundle exec rails g webpack:install && bundle exec rails g webpack:install:react && bundle exec rails g react:install"
